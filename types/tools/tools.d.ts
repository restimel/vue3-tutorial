import { BoxNotEmpty, ErrorDetails, ErrorSelectorPurpose, SelectorElement } from '../types.d';
...
export declare function getBox(el: HTMLElement, memo: WeakMap<HTMLElement, BoxNotEmpty>, isParent?: boolean): BoxNotEmpty;
export {};
