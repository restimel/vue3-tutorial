...
let SVG$1 = class SVG extends vtyx.Vue {
    /* }}} */
    /* {{{ data */
    /* }}} */
    /* {{{ computed */
...
let VStep = class VStep extends vtyx.Vue {
    ...
    setFocus() {
        ...
        switch (focusCfg) {
            ...
            case 'main-target': {
                ...
                const stopWatch = vue.watch(() => this.mainElement, () => {
    ...
    render() {
        ...
        return (vtyx.h(Window$1, { elementsBox: this.targetBoxes, masksBox: this.masksBox, position: options.position, arrow: this.arrowsPosition, arrowAnimation: options.arrowAnimation, mask: !!options.mask, maskMargin: options.maskMargin, teleport: options.teleport, offset: this.windowOffset },
            vtyx.h("aside", { slot: "content", class: "vue3-tutorial__step" },
                vtyx.h("header", { class: {
                    ...
                    vtyx.h("div", { class: "vue3-tutorial__step__header__status" }, label(options, 'stepState', {
                ...
                vtyx.h("nav", { class: "vue3-tutorial__step__commands" },
                    ...
                    this.displaySkipButton && (vtyx.h("button", { class: "vue3-tutorial__step__btn vue3-tutorial__step__btn-skip", on: {
                            click: () => this.$emit('skip'),
                        }, title: label(options, 'skipButtonTitle') }, "\u00D7")),
                    this.displayNextButton && (vtyx.h("button", { class: "vue3-tutorial__step__btn vue3-tutorial__step__btn-next", on: {
                            click: () => this.$emit('next'),
                        } }, label(options, 'nextButton'))),
                    this.displayFinishButton && (vtyx.h("button", { class: "vue3-tutorial__step__btn vue3-tutorial__step__btn-finish", on: {
...
__decorate([
    vtyx.Watch('step', { immediate: true })
], VTutorial.prototype, "onStepChange", null);
__decorate([
    vtyx.Watch('options', { immediate: true, deep: true })
], VTutorial.prototype, "onOptionsChange", null);
__decorate([
    vtyx.Emits(['changeStep', 'error', 'nextStep', 'previousStep', 'start', 'stop'])
