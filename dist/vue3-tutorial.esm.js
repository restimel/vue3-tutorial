...
let SVG$1 = class SVG extends Vue {
    ...
    /* }}} */
    render() {
        return (h("svg", { style: this.style, width: this.width, height: this.height, viewBox: this.viewBox, xmlns: "http://www.w3.org/2000/svg" },
            h("path", { d: this.path })));
    }
};
__decorate$4([
...
let SVG = class SVG extends Vue {
    ...
    /* }}} */
    render() {
        return (h("svg", { style: this.style, width: this.width, height: this.height, viewBox: this.viewBox, xmlns: "http://www.w3.org/2000/svg", class: "vue3-tutorial__svg-mask" },
            h("path", { d: this.path, style: this.maskStyle, class: "vue3-tutorial__mask" })));
    }
};
__decorate$3([
    Prop()
...
function checkPlacement(placement, info) {
    var _a;
    const dimension = (_a = info.placementSize.get(placement)) !== null && _a !== void 0 ? _a : info.elementSize;
    switch (placement) {
        case 'bottom':
...
function getAutoPlacement(targetBox, elementSize, placementSize) {
...
let Window = class Window extends Vue {
    constructor() {
        ...
        this.placementElementSize = new Map();
    ...
    render() {
        ...
        return (h("div", { class: "vue3-tutorial__window-container" },
            ...
            this.arrowsPosition.map((arrow) => (h(SVG$2, { width: "15", height: "15", viewBox: "0 0 30 30", path: "M0,0L0,15L5,5L25,30L25,25L30,25L5,5L15,0L0,0Z", style: `--vue3-tutorial-x: ${arrow.x}; --vue3-tutorial-y: ${arrow.y};`, class: [
                    'vue3-tutorial__window-arrow',
                    'position-' + arrow.position,
                    arrowAnimation ? 'animation' : '',
                ] }))),
            !!this.scrollPosition && (h(SVG$2, { width: "30", height: "30", viewBox: "0 0 30 30", path: "M0,0L0,15L7,7L10,30L30,10L7,7L15,0L0,0Z", style: this.styleScrollPosition, class: [
                    'vue3-tutorial__window-scroll-arrow',
                    'position-' + this.scrollPosition[2],
                    this.arrowAnimation ? 'animation' : '',
                ] })),
            h("div", { style: this.styleWindowCoords, class: [
...
__decorate$2([
    Prop()
], Window.prototype, "offset", void 0);
__decorate$2([
...
let VStep = class VStep extends Vue {
    ...
    async scrollTo() {
        ...
        if (typeof scroll === 'boolean') {
            ...
            behavior = (_a = scroll.scrollKind) !== null && _a !== void 0 ? _a : 'auto-scroll';
    ...
    render() {
        ...
        return (h(Window$1, { elementsBox: this.targetBoxes, masksBox: this.masksBox, position: options.position, arrow: this.arrowsPosition, arrowAnimation: options.arrowAnimation, mask: !!options.mask, maskMargin: options.maskMargin, teleport: options.teleport, offset: this.windowOffset },
...
let VTutorial = class VTutorial extends Vue {
    ...
    onOptionsChange() {
        ...
        /* Update labels */
        if (options === null || options === void 0 ? void 0 : options.texts) {
    ...
    mounted() {
        ...
        }, (_a = this.options) === null || _a === void 0 ? void 0 : _a.messageLog);
...
], VTutorial.prototype, "onOptionsChange", null);
__decorate([
